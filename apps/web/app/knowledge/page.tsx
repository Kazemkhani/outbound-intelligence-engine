    ...
    <div className="mx-auto max-w-4xl px-6 py-8">
      <header className="mb-6">
        ...
        <p className="mt-1.5 text-sm text-ink-400">
          ...
          closing, and the Huscribe product and competitive facts. Every answer is grounded in the
          canon and names the framework it draws on. Huscribe specifics you must confirm show as{" "}
