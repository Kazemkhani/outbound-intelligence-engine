 ...
 * score, and it never invents a Huscribe price/metric/proof point (those are
...
const KNOWLEDGE_SYSTEM = (canon: string): string =>
  [
    ...
    "- Never invent a Huscribe price, metric, customer name, or proof point. Where a specific is unknown, write the literal token <CONFIRM> and say what the operator must confirm.",
