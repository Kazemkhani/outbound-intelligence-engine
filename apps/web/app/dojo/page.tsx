...
export const metadata = {
  title: "Voice Dojo · OIE Control Plane",
};
    ...
    <div className="mx-auto max-w-4xl px-6 py-8">
      <header className="mb-6">
        ...
        <p className="mt-1.5 text-sm text-ink-400">
          Practise selling the configured product against a realistic B2B prospect, then get scored
          on your technique. The prospect plays in character and raises real objections; the coach
